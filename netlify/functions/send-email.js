...
export const handler = async (event) => {
  ...
  const { to, title, duration, playbackUrl, recordingId } = body
            ...
            <td style="padding:32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${playbackUrl}"
                       style="display:inline-block;padding:16px 40px;background:linear-gradient(135deg,#e8734a,#c0392b);color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;border-radius:50px;letter-spacing:0.2px;">
                      Listen to Recording
                    </a>
                  </td>
                </tr>
